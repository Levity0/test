...
- The team was able to complete the Research or potential site hosting, and make progress on certain Back-End systems such as Retrieve meal data from TheMealDB, Display meal catalogue, Search functionality, and Emailer.
- We found that being able to delegate the big tasks has been effective and it looks like we will be able to work more efficiently this way.
- We learned about many different systems that need to go into play here for everything to run smoothly
...
Team progress and issues:
- Kenneth Worked on the Emailer, and helped present deliverable 2
- Kenneth found that having everything organized continued faster preformance, additionally he was able to figure out the bulk of the emailer.
- Kenneth learned how to put together an Emailer for the user to send to their personal email.
